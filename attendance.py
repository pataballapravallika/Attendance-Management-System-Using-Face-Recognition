...
class Attendance:
    def __init__(self,root):
        ...
        img=Image.open(r"Images/S1.jpg")
        ...
        #2
        img1=Image.open(r"Images/S3.jpg")
        img1=img1.resize((1000,200),Image.Resampling.LANCZOS)
        self.photoimg1=ImageTk.PhotoImage(img1)

        f_lbl1=Label(self.root,image=self.photoimg1)
        f_lbl1.place(x=700,y=0,width=600,height=200)
        ...
        Left_frame.place(x=-1,y=0,width=600,height=580)
        
        img_left=Image.open("C:/Users/hp/OneDrive/Desktop/face_recognition System/Images/facer.jpg")
        ...
        left_inside_frame.place(x=0,y=135,width=595,height=250)
        ...
        btn_frame.place(x=0,y=180,width=600,height=35)
         
        save_btn=Button(btn_frame,text="Import CSV",command=self.importCsv,width=13,font=("time new roman",13,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Export CSV",command=self.exportCsv,width=14,font=("time new roman",13,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text="Update",width=14,font=("time new roman",13,"bold"),bg="blue",fg="white")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(btn_frame,text="Reset",width=14,command=self.reset,font=("time new roman",13,"bold"),bg="blue",fg="white")
        ...
        table_frame.place(x=0,y=5,width=595,height=300)
